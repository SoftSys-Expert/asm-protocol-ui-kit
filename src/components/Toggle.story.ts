...
import { createToggle } from "../core/Toggle";
  ...
  variants: [
    {
      ...
      onMount: ({ el }) => {
        ...
        const instance = createToggle({ label: "Dark mode", checked: true });
        ...
        const ttyInstance = createToggle({ label: "Dark mode", checked: true });
